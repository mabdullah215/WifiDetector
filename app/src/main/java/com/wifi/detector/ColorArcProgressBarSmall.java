...
public class ColorArcProgressBarSmall extends View {
    ...
    private  float hintSize = dipToPx ( 5 );
    private float curSpeedSize = dipToPx(10);
    private int aniSpeed = 1000;
    private float longdegree = dipToPx(8);
    private  float shortdegree =  dipToPx ( 4 );
    ...
    public ColorArcProgressBarSmall(Context context ) {
        super(context, null);
        initView();
    }

    public ColorArcProgressBarSmall(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public ColorArcProgressBarSmall(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        //The current progress of the arc
    ...
    /**
     * Set whether to display the external dial
     * @param isNeedDial
     */
