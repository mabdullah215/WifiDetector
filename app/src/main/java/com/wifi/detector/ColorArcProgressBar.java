...
public class ColorArcProgressBar extends View {
    ...
    private String hintColor = "#f9f5f5";
    private String longDegreeColor = "#f9f5f5";
    private String shortDegreeColor = "#f9f5f5";
    private String bgArcColor = "#f9f5f5";
